...
typedef struct {
  ...
  uint8_T DataTypeConversion_e;        /* '<S9>/Data Type Conversion' */
  uint8_T DataTypeConversion_c;        /* '<S10>/Data Type Conversion' */
} B_sersin_T;

/* Parameters (auto storage) */
struct P_sersin_T_ {
  real_T RepeatingSequence2_rep_seq_y[4];/* Mask Parameter: RepeatingSequence2_rep_seq_y
                                          * Referenced by: '<S7>/Look-Up Table1'
                                          */
  real_T RepeatingSequence1_rep_seq_y[4];/* Mask Parameter: RepeatingSequence1_rep_seq_y
  ...
  real_T Constant_Value_b;             /* Expression: period
                                        ...
                                        */
  real_T LookUpTable1_bp01Data_j[4];   /* Expression: rep_seq_t - min(rep_seq_t)
                                        * Referenced by: '<S6>/Look-Up Table1'
                                        */
  ...
  real_T Constant_Value_o;             /* Expression: 0
                                        ...
                                        */
  real_T Switch1_Threshold;            /* Expression: 80
 ...
 * '<S8>'   : 'sersin/Subsystem/Standard Servo Write'
 * '<S9>'   : 'sersin/Subsystem/Standard Servo Write1'
 * '<S10>'  : 'sersin/Subsystem/Standard Servo Write2'
 */
